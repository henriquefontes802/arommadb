...
def excluir_produto():
    # Recebe o ID do produto do formulário
    ...
    # Redireciona de volta para a lista de produtos ou retorna uma mensagem de sucesso
    #return ('Produto excluído com sucesso! Volte e consulte novamente.')
    return f"""
    <script>
